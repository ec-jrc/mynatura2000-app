cordova.define("eu.europa.ec.ecas.ECASMobile", function(require, exports, module) {
/*
...
module.exports = {
  ...
  */
  ...
  ...
  */
  requestECASMobileAppAuthentication : function(callbackUrl, successCallback, failCallback) {
    cordova.exec(
      successCallback,
      failCallback,
      'ECASMobile',
  ...
  ...
  */
  requestDesktopProxyTicket : function(dpgt, service, successCallback, failCallback) {
    cordova.exec(
      successCallback,
      failCallback,
      'ECASMobile',
  ...
  */
  ...
  ...
  */
  validateServiceTicket : function(ticket, service, env, successCallback, failCallback) {
    cordova.exec(
      successCallback,
      failCallback,
      'ECASMobile',
